...
col_types <- readr::cols(
  ...
  #publish_date = readr::col_datetime(format = "%m/%e/%Y %H:%M"),
  #harvested_date = readr::col_datetime(format = "%m/%e/%Y %H:%M")
)
...
## slimmed down data set (top four groups, must have publish date, and 
